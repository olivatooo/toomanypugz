...
function generate_smg(Location, Rotation, tier)
  ...
  if tier == 1 then
    base_damage = 1
    cadence = random_float(0.12, 0.14)
    bullet_count = 1
  ...
  if tier == 5 then
    ...
    cadence = random_float(0.06, 0.09)
    bullet_count = 1
...
function generate_rifle(Location, Rotation, tier)
 ...
 local magazine_mesh = nil
  ...
  if tier == 2 then
    base_damage = math.random (2, 4)
    cadence = random_float(0.16, 0.18)
    bullet_count = 1
  ...
  if tier == 3 then
    base_damage = math.random (4, 8)
    cadence = random_float(0.14, 0.16)
    bullet_count = 1
...
function pugz(Location, Rotation, tier)
	local model = nil
 local trail = nil
 local barrel = nil
 local shell = nil
...
TmpzWeapons = {
  ...
  PugzTier = function(Location, Rotation, Tier)
    return pugz(Location, Rotation, Tier)
  end,
}